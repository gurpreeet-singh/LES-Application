...
const DEMO_PERSONAS = [
  ...
  },
  {
    ...
    email: 'prof.college@university.edu',
    password: 'college123',
    navRole: 'teacher',
    color: '#7C3AED',
    icon: '🎓',
    logos: ['ikigai', 'horizon'],
    highlights: ['3 interconnected courses (CS, Math, ML)', 'Cross-course knowledge graph', 'Prerequisite bottleneck detection', 'Multi-course student analytics'],
  },
  {
    id: 'college-student',
    institution: 'Horizon University College',
    ...
    icon: '📝',
    logos: ['ikigai', 'horizon'],
    highlights: ['Enrolled in 3 courses (CS, Math, ML)', 'Take quizzes across courses', 'Switch between courses', 'Track cross-course progress'],
  },
];
